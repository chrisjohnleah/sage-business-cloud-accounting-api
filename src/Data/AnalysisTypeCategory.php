...
final readonly class AnalysisTypeCategory
{
    use MapsAttributes;
    ...
    public function __construct(
        ...
        public ?string $combinedId = null,
        public ?Reference $analysisType = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            combinedId: self::string($data, 'combined_id'),
            analysisType: Reference::fromNullable(self::nested($data, 'analysis_type')),
        );
    }
