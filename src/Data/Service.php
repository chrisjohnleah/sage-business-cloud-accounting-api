...
final readonly class Service
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            salesRates: array_map(static fn (array $item): Rate => Rate::fromArray($item), self::nestedList($data, 'sales_rates')),
            ...
            ossService: self::boolean($data, 'oss_service'),
        );
    }
