...
final readonly class DraftTaxReturn
{
    use MapsAttributes;
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            taxReturnId: self::integer($data, 'tax_return_id'),
            submittedDate: self::dateTime($data, 'submitted_date'),
        );
    }
