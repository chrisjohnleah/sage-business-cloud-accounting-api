...
final readonly class SalesInvoice
{
     ...
     * @param  list<SalesCorrectiveInvoice>  $corrections
     */
    public function __construct(
        ...
        public ?RecurringSalesInvoice $recurringInvoice = null,
        ...
        public ?SalesInvoiceQuoteEstimate $originalQuoteEstimate = null,
        public ?Reference $taxAddressRegion = null,
        public ?string $deliveryPerformanceDate = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            recurringInvoice: RecurringSalesInvoice::fromNullable(self::nested($data, 'recurring_invoice')),
            ...
            originalQuoteEstimate: SalesInvoiceQuoteEstimate::fromNullable(self::nested($data, 'original_quote_estimate')),
            taxAddressRegion: Reference::fromNullable(self::nested($data, 'tax_address_region')),
            deliveryPerformanceDate: self::string($data, 'delivery_performance_date'),
            ...
            corrections: array_map(static fn (array $item): SalesCorrectiveInvoice => SalesCorrectiveInvoice::fromArray($item), self::nestedList($data, 'corrections')),
