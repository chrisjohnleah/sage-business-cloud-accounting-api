...
final readonly class SalesCreditNote
{
    use MapsAttributes;
     ...
     * @param  list<SalesCreditNoteLineItem>  $creditNoteLines
    ...
    public function __construct(
        ...
        public ?string $creditNoteNumberPrefix = null,
        public ?string $creditNoteNumber = null,
        public ?string $contactName = null,
        public ?string $contactReference = null,
        public ?DateTimeImmutable $date = null,
        public ?DateTimeImmutable $originalInvoiceDate = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            creditNoteNumberPrefix: self::string($data, 'credit_note_number_prefix'),
            creditNoteNumber: self::string($data, 'credit_note_number'),
            contactName: self::string($data, 'contact_name'),
            contactReference: self::string($data, 'contact_reference'),
            date: self::dateTime($data, 'date'),
            originalInvoiceDate: self::dateTime($data, 'original_invoice_date'),
            ...
            creditNoteLines: array_map(static fn (array $item): SalesCreditNoteLineItem => SalesCreditNoteLineItem::fromArray($item), self::nestedList($data, 'credit_note_lines')),
