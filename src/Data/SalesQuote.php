...
final readonly class SalesQuote
{
     ...
     * @param  list<SalesQuoteLineItem>  $quoteLines
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            quoteNumber: self::string($data, 'quote_number'),
            ...
            quoteLines: array_map(static fn (array $item): SalesQuoteLineItem => SalesQuoteLineItem::fromArray($item), self::nestedList($data, 'quote_lines')),
