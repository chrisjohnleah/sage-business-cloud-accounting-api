...
final readonly class PurchaseCreditNote
{
    use MapsAttributes;

    /**
     * @param  list<Link>  $links
     * @param  list<PurchaseCreditNoteLineItem>  $creditNoteLines
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            creditNoteLines: array_map(static fn (array $item): PurchaseCreditNoteLineItem => PurchaseCreditNoteLineItem::fromArray($item), self::nestedList($data, 'credit_note_lines')),
