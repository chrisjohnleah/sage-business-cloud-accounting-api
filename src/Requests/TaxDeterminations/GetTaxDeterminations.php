...
namespace ChrisJohnLeah\SageAccounting\Requests\TaxDeterminations;
 ...
 *
 * GET /tax_determinations
 */
class GetTaxDeterminations extends SageRequest
{
    /**
