 ...
 *
 * POST /purchase_credit_notes/{key}/release
 */
class PostPurchaseCreditNotesKeyRelease extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return str_replace('{key}', rawurlencode($this->key), '/purchase_credit_notes/{key}/release');
    }
