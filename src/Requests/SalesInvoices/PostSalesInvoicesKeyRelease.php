 ...
 *
 * POST /sales_invoices/{key}/release
 */
class PostSalesInvoicesKeyRelease extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return str_replace('{key}', rawurlencode($this->key), '/sales_invoices/{key}/release');
    }
